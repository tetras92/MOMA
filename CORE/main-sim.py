...
if __name__ == "__main__":
    ...
    mcda_problem_description = ProblemDescription(criteriaFileName="CSVFILES/criteria.csv",
                                                  performanceTableFileName="CSVFILES/sim-PerfTable.csv")
    ...
    DA(problemDescription=mcda_problem_description,
       ...
       ExplanationWrapper=ExplanationWrapper(ListOfExplanationEngines=list([Explain.Order2SwapMixedExplanation]),
