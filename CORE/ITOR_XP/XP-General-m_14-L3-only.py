            ...
            for A in A_list:
                for W in W_list:
                    if number % 10000 == 0:
                        ...
                        if number != 0:
                            print("*:", RESULT_RECO_ETOILE[3]/number, "tree:", RESULT_RECO_TRANSITIVITY[3] / number, "relax:", RESULT_RECO_RELAXATION[3] / number)
                        # if number != 0:
                        #     print(tmps_1 / number,  tmps_N / number, tmps_relax / number, tmps_translation / number, "secondes")
                    number += 1
