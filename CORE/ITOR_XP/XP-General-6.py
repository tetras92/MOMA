...
cbto_directory_m6 = f'/home/manuel239/PycharmProjects/MOMA/CORE/SIMULATION/CBTO{m}'
...
if __name__ == "__main__":
    ...
    for A_list_file in os.listdir(A_dest_directory):
        for W_list_file in os.listdir(W_dest_directory):
            ...
            ilanguage = 0
            for language in [decompose_under_L0, decompose_under_L1, decompose_under_L2, decompose_under_L3]:
                print("Date", datetime.now())
                print(language.__name__, ilanguage)
                result = 0
                result_transitivity = 0
                result_relaxation = 0
                result_transitivity_relaxation = 0
                for A in A_list:
                    for W in W_list:
                        ...
                        if success_h1:
                            ...
                            if success_hN:
                                # print(W, A) #Utilise ce 10/02/22 pour verifier la correction de usage of transitivity
                                result_transitivity += 1
                            ...
                            if success_relax or success_hN:
                                result_transitivity_relaxation += 1
                print("Date", datetime.now())
                ...
                print("gain:transitivity-relaxation", 100. * result_transitivity_relaxation / len(A_list) / len(W_list), "%")
